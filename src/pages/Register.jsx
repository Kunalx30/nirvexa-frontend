...
import { User, Mail, Lock, Eye, EyeOff, CheckCircle, XCircle, ArrowRight, Loader2 } from 'lucide-react'
...
export default function Register() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      toast.success('Welcome to NirVexa!')
      navigate('/chat')
    } catch (err) {
      ...
      <div className="w-full max-w-[420px] relative z-10 py-6">
        ...
        <div className="bg-[#111116]/80 backdrop-blur-xl border border-white/5 rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-2xl">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-gray-500 text-[10px] font-medium uppercase tracking-wider">or register with email</span>
            <div className="flex-1 border-t border-white/5" />
          </div>
